...
$anoserie               = $ano_serie;
$episodiosserie           = $episodios_serie . ' pags';
  ...
  <div style="text-align: center;">
   ...
   <table cellpadding="2" cellspacing="2"
    ...
    <tr>
     ...
     <td><strong>Animal 1</strong></td>
     <td>$autor1serie</td>
     <td><strong>Coste</strong></td>
     <td>$costeserie</td>
    </tr><tr>
     <td><strong>Animal 2</strong></td>
     <td>$autor2serie</td>
     <td><strong>Ventas</strong></td>
     <td>$ventasserie</td>
    </tr><tr>
     <td><strong>Numero de Animales</strong></td>
     <td>$episodiosserie</td>
...
$table.= <<<ENDHTML
   ...
   <table cellpadding='2' cellspacing='2'
    ...
    <tr>
     <th style="width: 7em;"><a href="N3P308details.php?idserie2=$idserie&orden=review_date">Fecha</a></th>
     <th style="width: 10em;"><a href="N3P308details.php?idserie2=$idserie&orden=reviewer_name">Reviewer</th>
     <th><a href="N3P308details.php?idserie2=$idserie&orden=review_comment">Comentarios</th>
     <th style="width: 5em;"><a href="N3P308details.php?idserie2=$idserie&orden=review_rating">Rating</th>
    </tr>
ENDHTML;
